...
const EditBeneficiary = ({ beneficiary, isOpen, onClose }: EditBeneficiaryProps) => {
  ...
  const mutation = useMutation({
    mutationFn: (data: BeneficiaryUpdate) =>
      BeneficiariesService.updateBeneficiary({ id: beneficiary.id, requestBody: data }),
    onSuccess: () => {
      showToast("Success!", "Beneficiary updated successfully.", "success")
      onClose()
    },
  ...
  const onSubmit: SubmitHandler<BeneficiaryUpdate> = async (data) => {
